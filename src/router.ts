...
// tslint:disable-next-line: no-floating-promises
  makeHot(homeModuleId, homeComponent,
    module.hot.accept('./components/home', () => reload(homeModuleId, (require('./components/home')).HomeComponent)));

// tslint:disable-next-line: no-floating-promises
  makeHot(aboutModuleId, aboutComponent,
    module.hot.accept('./components/about', () => reload(aboutModuleId, (require('./components/about')).AboutComponent)));
// tslint:disable-next-line: no-floating-promises
  makeHot(listModuleId, listComponent,
    module.hot.accept('./components/list', () => reload(listModuleId, (require('./components/list')).ListComponent)));
}
